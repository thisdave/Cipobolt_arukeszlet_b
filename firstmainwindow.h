...
//private adattagok
  ...
  QTableWidgetItem * newCipomodellId2Item;
  QTableWidgetItem * newCipomodellNev2Item;
  QTableWidgetItem * newCipomodellAr2Item;
 unsigned adattagok_oszlopindex;
 public:
